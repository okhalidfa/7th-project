...
const Home = () => {
  ...
  if (loading) return <div className="flex justify-center items-center min-h-screen bg-[#F2F2F7]"><span className="loading loading-spinner loading-lg text-[#244D3F]"></span></div>;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-4 pb-6">
          {friends.map((friend) => (
            ...
            >
              ...
              />
              <h2 className="text-center font-semibold mt-2">{friend.name}</h2>
